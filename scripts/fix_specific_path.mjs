// A script to fix a specific incorrect file path in the database.
// Run this script from your project root using: node ./scripts/fix_specific_path.mjs
...
const INCORRECT_PATH = "uploads/PAVITRA-K.pdf";
const CORRECT_PATH = "abe86c65-58d0-4b41-b427-de82ac4a9159/1750553723544_PAVITRA-K.pdf";

// --- SCRIPT ---
const supabase = createClient(SUPABASE_URL, SUPABASE_SERVICE_KEY);

console.log(`✅ Supabase client initialized. Attempting to fix file path.`);

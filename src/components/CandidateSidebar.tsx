...
export const CandidateSidebar = () => {
    ...
    return (
        <div className="hidden lg:flex flex-col w-64 bg-white/90 text-blue-900 h-screen fixed top-0 left-0 border-r border-blue-100">
            <div className="flex items-center h-20 px-6 border-b border-blue-100">
                <Sparkles className="w-8 h-8 text-blue-500" />
                <h1 className="text-2xl font-bold ml-3 tracking-wider text-blue-900">AImploy</h1>
            </div>
